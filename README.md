...
* **STARC-9 (Stanford multi-centric cohort):**
  Sampled 63,000 tiles from the available STARC-9 training data using stratified sampling (seed 42) and evaluated on the full 54,000-tile official validation split to evaluate how dataset scale acts as a regularizer.
