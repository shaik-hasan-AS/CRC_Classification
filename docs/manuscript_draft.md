...
### 7.3 The Negative Space Shortcut (Honest Limitation)
Despite high alignment scores, our analysis revealed a critical shortcut: on several challenging Stroma (STR) patches, the average Grad-CAM activation on the *empty slide background* (0.198) was mathematically higher than the activation on the actual cellular tissue (0.137). 
